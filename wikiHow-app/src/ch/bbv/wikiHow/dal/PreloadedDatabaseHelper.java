...
class PreloadedDatabaseHelper extends SQLiteOpenHelper implements DatabaseHelper {
    ...
    public void openDatabase() throws SQLException {
        final String dbPath = getDatabasePath();
        this.database = SQLiteDatabase.openDatabase(dbPath, null, SQLiteDatabase.OPEN_READONLY);
    }
    ...
    public Cursor query(final boolean distinct, final String databaseTable, final String[] columns, final String selection, final String[] selectionArgs,
        ...
        return this.database.query(distinct, databaseTable, columns, selection, selectionArgs, groupBy, having, orderBy, limit);
    }
